        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-lg font-bold">{walletInfo.balance.toFixed(2)} ADA</p>
            </div>
            <Badge variant={walletInfo.network === 'testnet' ? 'secondary' : 'default'}>
              {walletInfo.network}
            </Badge>
          </div>
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardDescription>
          Connect your Eternl wallet to register and receive ADA rewards for e-waste recycling
        </CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
        ...
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
          <p className="text-xs text-blue-600">
            <strong>Why Eternl?</strong> Eternl is the most advanced Cardano wallet with support for:
          </p>
