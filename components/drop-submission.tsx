...
export default function DropSubmission({
  ...
  const selectedLevel = riskLevels.find(
    (level) => level.level === selectedRiskLevel,
  );
      ...
      <Card className="border-green-500 bg-green-50">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-green-700 mb-4">
            Your e-waste drop has been submitted for review. Estimated reward:{" "}
            <strong>{estimatedTokens} ADA tokens</strong>
          </p>
          <p className="text-green-600 text-sm mb-6">
            You will receive a notification once the admin verifies your
            submission (usually within 1 week).
          </p>
