...
const realWalletAddress = 'addr_test1qr97zegrra6jedlq5885fhxjrle8zr2zyrdkklptwvdk0scwq03mzrumqqfnld64zuu9rtlca9nhjwaazqlnj4wtjmcqa7ppyc'
  ...
  try {
    ...
    for (let i = 0; i < users.length; i++) {
      ...
      if (error) {
        ...
        updatedCount++
        console.log(`✅ Updated ${user.user_id}: ${walletAddress ? 'Has wallet' : 'No wallet'}`)
      }
    }
